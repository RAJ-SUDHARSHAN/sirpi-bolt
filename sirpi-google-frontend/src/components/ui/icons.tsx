...
export function BitbucketIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M2.65 3C2.3 3 2 3.3 2 3.65v.12l2.73 16.5c.07.42.43.73.85.73h13.05c.31 0 .59-.22.64-.54L22 3.77a.643.643 0 00-.54-.74.65.65 0 00-.11-.03zm11.57 12c-.38 0-3.16-.01-3.16-.01-.53 0-.94-.44-.94-.94 0-.5.41-.94.94-.94h3.16c.53 0 .94.44.94.94.01.5-.41.95-.94.95zm-.02-4c.53 0 .94-.44.94-.94 0-.5-.41-.94-.94-.94-1.42 0-3.8.01-5.16.01-.53 0-.94.44-.94.94 0 .5.41.94.94.94l5.16-.01z" />
    </svg>
  );
}
...
export function ForkIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      fill="none"
      stroke="currentColor"
      ...
      {...props}
    >
      <path d="M7 3v12M17 21v-8M3 15h8M14 3h7v7M7 7h12M7 11h6" />
    </svg>
  );
}
...
export function RocketLaunchIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      fill="none"
      stroke="currentColor"
...
export function CpuChipIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      fill="none"
      stroke="currentColor"
